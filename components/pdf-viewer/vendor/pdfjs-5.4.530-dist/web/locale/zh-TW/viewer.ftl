...
pdfjs-views-manager-view-selector-button =
    .title = 檢視
pdfjs-views-manager-view-selector-button-label = 檢視
...
pdfjs-views-manager-pages-status-none-action-label = 選取頁面
...
pdfjs-views-manager-pages-status-waiting-ready-label = 正在準備檔案…
pdfjs-views-manager-pages-status-waiting-uploading-label = 正在上傳檔案…

pdfjs-views-manager-status-warning-cut-label = 無法剪下。請重新整理頁面後再試。
pdfjs-views-manager-status-warning-copy-label = 無法複製。請重新整理頁面後再試。
pdfjs-views-manager-status-warning-delete-label = 無法刪除。請重新整理頁面後再試。
pdfjs-views-manager-status-warning-save-label = 無法儲存。請重新整理頁面後再試。
